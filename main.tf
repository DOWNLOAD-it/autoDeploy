...
resource "local_file" "ansible_inventory" {
  ...
  content  = <<EOT
[jenkins]
jenkins_server ansible_host=${aws_instance.jenkins_server.public_ip} ansible_user=admin ansible_ssh_private_key_file=~/cloud-project-key.pem

[master]
master_node ansible_host=${aws_instance.k8s_master.public_ip} ansible_user=admin ansible_ssh_private_key_file=~/cloud-project-key.pem

[worker]
worker_node ansible_host=${aws_instance.k8s_worker.public_ip} ansible_user=admin ansible_ssh_private_key_file=~/cloud-project-key.pem
